...
- [ ] mTLS Controller Mesh (Sprint 32 Tickets 56-57 in progress; shared `LoadMutualTLSConfig`, `NewMutualTLSHTTPClient`, Subject-CN allowlist middleware, and Prometheus client-cert scrape wiring landed for owned listeners. External-daemon TLS remains a follow-up.)
