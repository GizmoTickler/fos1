...
- [ ] mTLS Controller Mesh + External-Daemon TLS (Sprint 32 Tickets 56-58 in progress; shared `LoadMutualTLSConfig`, `NewMutualTLSHTTPClient`, Subject-CN allowlist middleware, Prometheus client-cert scrape wiring, and FRR vtysh mTLS sidecar landed locally. Suricata, Kea, Zeek, and chronyc external-daemon TLS remain follow-ups.)
