...
- Remaining gaps are broader than the owned baseline: no proof yet for PVC failover behavior, the production `14d` wall-clock deletion on `fos1-security-*`/`fos1-logs-*`, optional operator resources, or dashboards
